...
<div class="max-w-2xl mx-auto">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Редактировать заметку</h1>

    <form action="{{ route('notes.update', $note) }}" method="POST" class="bg-white rounded-lg shadow-md p-8">
        @csrf
        ...
        <div class="mb-6">
            ...
            <div x-data="colorPicker('{{ $note->color }}')" class="flex gap-3">
